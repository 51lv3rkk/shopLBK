            ...
            <div class="col-md-9">
                <div class="container-fluid p-0">
                    <?php if(isset($_GET['search'])): ?>
                        <h4 class="text-center py-5"><b>Tìm kiếm: '<?php echo $_GET['search'] ?>'</b></h4>
                    <?php endif; ?>
                <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-4">
                            ...
                            <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                                ...
                                <div class="card-body p-4">
                                    <div class="">
                                        ...
                                        <!-- Product price-->
                                        <span><b>Giá: </b><?php echo $price ?> đ</span>
                                    </div>
                        ...
                        <?php 
                            if($products->num_rows <= 0){
                                echo "<h4 class='text-center'><b>Không tìm thấy sản phẩm nào!</b></h4>";
                            }
                        ?>
                    </div>
                </div>
