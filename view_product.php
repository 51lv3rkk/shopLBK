    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <p class="m-0"><small>Nhãn hiệu: <?php echo $bname ?></small></p>
                <div class="fs-5 mb-5">
                Giá: <span id="price"><?php echo isset($inv[0]['price']) ?  format_num($inv[0]['price']) : "--" ?> đ</span>
                <br>
                <span><small><span class="text-muted">Còn:</span> <span id="avail"><?php echo isset($inv[0]['stock']) ? format_num($inv[0]['stock']) : "--" ?></span></small></span>
                <h5>Loại</h5>
                <?php 
                    $active = false;
                foreach($inv as $k => $v):
                ...
                <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <!-- Product price-->
                            <span><b class="text-muted">Giá: </b><?php echo $price ?> đ</span>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp == 'object' && resp.status=='success'){
                        alert_toast("Đã thêm vào giỏ hàng.",'success')
