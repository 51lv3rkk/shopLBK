        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Cập nhập thông tin cá nhân</b></h4>
                    <a href="./?p=my_account" class="btn btn btn-default btn-flat bg-maroon"><div class="fa fa-angle-left"></div> Quay lại</a>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label">Địa chỉ mặc định</label>
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted"><i>Bỏ qua nếu bạn không muốn thay đổi.</i></small>
                            </div>
                            <div class="form-group">
                                ...
                                <small class="text-muted"><i>Nhập mật khẩu hiện tại để cập nhật thông tin.</i></small>
                            </div>
