...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=product/manage_product" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Tạo sản phẩm mới</a>
		</div>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
                                <?php if($row['status'] == 1): ?>
                                    <span class="badge badge-success px-3 rounded-pill">Đang bán</span>
                                <?php else: ?>
                                    <span class="badge badge-danger px-3 rounded-pill">Dừng bán</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xóa sản phẩm này vĩnh viễn không?","delete_product",[$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [
