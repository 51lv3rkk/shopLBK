...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xoá khách hàng này?","delete_client",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Cập nhật thông tin chi tiết khách hàng","clients/manage_client.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
