...
<div class="card card-outline card-primary">
    <div class="card-body">
        <div class="conitaner-fluid">
            ...
            <p><b>Địa chỉ: <?php echo $delivery_address ?></b></p>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>Nhãn hiệu: <?php echo $row['bname']?></small></p>
                           
                        </td>
                        <td class="text-right"><?php echo number_format($row['price']) ?> đ</td>
                        <td class="text-right"><?php echo number_format($row['price'] * $row['quantity']) ?> đ</td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
                <tfoot>
        ...
        <div class="row">
            ...
            <div class="col-6 row row-cols-2">
                ...
                <?php 
                    switch($status){
                        case '0':
                            echo '<span class="badge badge-light text-dark border px-3 rounded-pill">Đang chờ</span>';
	                    break;
                        case '1':
	                    ...
	                    break;
                        default:
                            echo '<span class="badge badge-danger px-3 rounded-pill">Đã huỷ</span>';
	                    break;
                    }
                ?>
                </div>
                ...
                <div class="col-3"></div>
                <div class="col">
                    <button type="button" id="update_status" class="btn btn-sm btn-flat btn-primary">Sửa trạng thái</button>
                </div>
                <?php endif; ?>
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-danger btn-flat btn-sm" id="cancel_order">Huỷ đơn hàng</button>
    <?php endif; ?>
...
<script>
    $(function(){
        ...
        $('#cancel_order').click(function(){
            _conf("Bạn có chắc muốn huỷ đơn hàng này?","cancel_order",[])
        })
        $('#pay_order').click(function(){
			_conf("Bạn đã chắc chắn Khách hàng đã thanh toán?","pay_order",["<?= isset($id) ? $id : "" ?>"])
		})
    })
