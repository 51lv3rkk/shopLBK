				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="text-right"><?php echo number_format($row['amount']) ?> đ</td>
							<td class="text-center">
                                <?php if($row['paid'] == 0): ?>
                                    <span class="badge badge-light border px-2 rounded-pill">Chưa thanh toán</span>
                                <?php else: ?>
                                    <span class="badge badge-success px-2 rounded-pill">Đã thanh toán</span>
                                <?php endif; ?>
                            </td>
							<td class="text-center">
                                <?php if($row['status'] == 0): ?>
                                    <span class="badge badge-light border px-3 rounded-pill">Đang chờ</span>
                                ...
                                <?php else: ?>
                                    <span class="badge badge-danger px-3 rounded-pill">Đã huỷ</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=orders/view_order&id=<?php echo $row['id'] ?>">Chi tiết</a>
